...
const projects: Project[] = [
  {
    ...
    description: "A comprehensive task management platform with real-time collaboration, drag-and-drop functionality, and team workspaces. Built with modern web technologies for seamless user experience.",
  ...
  },
  {
    ...
    description: "Advanced AI-powered image generation tool leveraging machine learning models to create unique artwork from text prompts. Features include style transfer and image editing capabilities.",
  ...
  },
  {
    ...
    description: "Modern chat application with real-time messaging, user presence indicators, and multimedia support. Features include group chats, file sharing, emoji reactions, and end-to-end encryption for secure communications.",
    ...
    observerRef.current = new IntersectionObserver((entries) => {
      entries.forEach(entry => {
        ...
        if (entry.isIntersecting) {
          // Image is entering viewport - turn ON
          imageWrapper.classList.remove('crt-inactive');
          imageWrapper.classList.add('crt-active');
        } else {
          // Image is leaving viewport - turn OFF
          imageWrapper.classList.remove('crt-active');
          imageWrapper.classList.add('crt-inactive');
        }
      });
    }, options);
